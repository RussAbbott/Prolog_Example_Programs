...
|									                                      |
|       Modified 2014 by Peter Schachte                                   |
|_________________________________________________________________________|
...
borders(czechoslovakia,russia).
borders(czechoslovakia,germany).
...
borders(germany,atlantic).
borders(germany,austria).
borders(germany,baltic).
...
borders(hungary,russia).
borders(hungary,yugoslavia).

borders(iceland,atlantic).

borders(ireland,united_kingdom).
borders(ireland,atlantic).
...
borders(united_kingdom,ireland).
...
borders(russia,afghanistan).
borders(russia,china).
borders(russia,czechoslovakia).
borders(russia,finland).
borders(russia,hungary).
borders(russia,iran).
borders(russia,mongolia).
borders(russia,north_korea).
borders(russia,norway).
borders(russia,poland).
borders(russia,romania).
borders(russia,turkey).
borders(russia,arctic_ocean).
borders(russia,baltic).
borders(russia,black_sea).
borders(russia,caspian).
borders(russia,pacific).
...
borders_X(A, B) :- borders(A, B).
borders_X(A, B) :- \+ borders(A, B), borders(B, A).

excluded(X) :-
    member(X, [arctic_ocean, atlantic, baltic, black_sea, indian_ocean,
